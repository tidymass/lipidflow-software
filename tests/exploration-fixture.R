...
s$IS_Name<-ifelse(s$IS_ID=='IS_001','PC standard','PE standard');s$mz<-c(753,711,775,733);s$rt<-100;s$Peak_Area<-c(1000,2000,500,600);s$Norm_Area<-c(1,1,.5,.3);s$Shape_Score<-c(.8,.9,.6,.7);s$Combined_Score<-.6*s$Norm_Area+.4*s$Shape_Score
